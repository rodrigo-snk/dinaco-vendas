...
public class EnvioEmailLogAnx implements EventoProgramavelJava {
    @Override
    public void beforeInsert(PersistenceEvent persistenceEvent) throws Exception {
        ...
        try {
            ...
            BigDecimal codFila = anexoVO.asBigDecimalOrZero("CODFILA");
            ...
            if (!BigDecimalUtil.isNullOrZero(nuNota)) {
                ...
                if (enviaEmailParaLogistica && RegraNegocio.verificaRegra(BigDecimal.valueOf(12), codTipOper) && !StringUtils.isEmpty(email)) {
                    ...
                    novoAnexoVO.setProperty("NUANEXO", anexoVO.asBigDecimalOrZero("NUANEXO"));
